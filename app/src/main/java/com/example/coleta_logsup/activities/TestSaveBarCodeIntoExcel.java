...
public class TestSaveBarCodeIntoExcel extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    fos.flush();
                    fos.close();
                    Toast.makeText(TestSaveBarCodeIntoExcel.this, "Dados salvos com sucesso!", Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    e.printStackTrace();
                    //Toast.makeText(TestSaveBarCodeIntoExcel.this, "Erro ao salvar os dados!", Toast.LENGTH_SHORT).show();
                    Toast.makeText(TestSaveBarCodeIntoExcel.this, "Erro ao salvar os dados: " + e.getMessage(), Toast.LENGTH_SHORT).show();
